...
btnOne = Button(calc, text="1", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(1)
				).grid(row=4, column=0, pady=1)

btnFour = Button(calc, text="4", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(4)
				).grid(row=3, column=0, pady=1)

btnSeven = Button(calc, text="7", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(7)
				).grid(row=2, column=0, pady=1)

btnTwo = Button(calc, text="2", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(2)
				).grid(row=4, column=1, pady=1)

btnFive = Button(calc, text="5", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(5)
				).grid(row=3, column=1, pady=1)

btnEight = Button(calc, text="8", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(8)
				).grid(row=2, column=1, pady=1)

btnThree = Button(calc, text="3", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(3)
				).grid(row=4, column=2, pady=1)

btnSix = Button(calc, text="6", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(6)
				).grid(row=3, column=2, pady=1)

btnNine = Button(calc, text="9", width=6,
				height=2, bg='black', fg='white',
				font=('Helvetica', 20, 'bold'),
				bd=4, command=lambda: added_value.numberEnter(9)
